...
<body id="bg">
					...
					<div class="sticky">						
						<div class="box with-padding human-cause">							
							...
							<div class="cause-progressbar">								
								<div class="supported">									
									<span>Переглянуло</span>
									<span class="payments-count" data-value="60638"><?php echo $patient['views']; ?></span>
									<span>людей</span>
								</div>
                                <?php
                                $procent = ($patient['progress']/$patient['goal_summ'])*100;
                                
                                ?>
								<div class="progress" style="height: 30px;">
									<div class="progress_width">
										<div class="progress-bar" role="progressbar" style="width: <?php echo $procent; ?>%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>

										<div class="text">
											<span class="amount" data-value="<?php echo $patient['progress']; ?>"><?php echo $patient['progress']; ?></span>
											<small>
												(<span class="percentage" data-value="<?php echo $procent; ?>"><?php echo substr($procent,0,4); ?>%</span>)
											</small>										
										</div>
									</div>
								</div>
								<div class="still-needed">									
									<span>Щоб досягти нашої мети:</span>
									<span class="amount-left" data-value="<?php echo $patient['goal_summ']; ?>"><?php echo $patient['goal_summ'];?> UA</span>
								</div>
							</div> <!-- /progressbar -->                                
                            <center>
                            <?php 
                            ...
                            ?>
								...
								<button class="sp-button big red with-icon full-width" type="button" data-toggle="modal" data-target="#myModal">								
									<span class="icon">
								...
								<div class="modal fade in" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
									<div class="modal-dialog" role="document" style="margin-top: 56.5px;">
										<div class="modal-content">										
											...
											<div class="modal-body">															
												<form action="" method='post'>
													<div class="row">
														<p class="m-b10">Яку суму ви хочете пожертвувати?</p>
														<div class="col-md-6 col-xs-12 col-sm-6 m-b15">
															<input type="text" class="form-controls" placeholder="Amount" name='amount'>
														</div>
														<br/> 
														<p class="m-b10 m-t15">Персональні дані</p>
														<div class="col-md-6 col-xs-12 col-sm-6 m-b15">
															<input type="text" class="form-controls" placeholder="First Name" name='firstname'>
														</div>
														<div class="col-md-6 col-xs-12 col-sm-6 m-b15">
															<input type="text" class="form-controls" placeholder="Last Name" name='lastname'>
														</div>
														<div class="col-md-6 col-xs-12 col-sm-6 m-b15">
															<input type="text" class="form-controls" placeholder="Phone Number" name='phonenumber'>
														</div>
														<div class="col-md-6 col-xs-12 col-xs-12 col-sm-6 m-b15">
															<input type="text" class="form-controls" placeholder="Email" name='emailtrans'>
														</div>														
													</div>
									    			<button  type='submit' name='go_tranc' class="btn btn-primary btn-lg">Пожертвувати</button>
												</form> <!-- /form -->												
											</div> <!-- /modal-body -->										
										</div> <!-- /modal-content -->
									</div> <!-- /modal-dialog -->
	...
	<footer class="page-footer font-small stylish-color-dark pt-4">
		<div class="container text-center text-md-left">
			<div class="row">
				<div class="col-md-4 mx-auto wow fadeIn" data-wow-delay="0.3s">
				...
				<hr class="clearfix w-100 d-md-none">
				<div class="col-md-4 mx-auto content wow fadeIn" data-wow-delay="0.6s">
